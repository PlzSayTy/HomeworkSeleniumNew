...
public class FirstScenarioTest {
    ...
    public void mainTest(){
        ...
        driver.findElement(By.xpath("//*[contains(text(),'Телефон')]/../input")).click();
        driver.findElement(By.xpath("//*[contains(text(),'Телефон')]/../input")).sendKeys("9168378267");
        ...
        driver.findElement(By.xpath("//input[contains(@name, 'ContactDate')]")).sendKeys("\n");
        ...
        Assertions.assertAll("Упс, что-то заполнилось не так", (Executable) () ->{
        ...
        Assert.assertEquals("12.03.2020", driver.findElement(By.xpath("//input[contains(@name, 'ContactDate')]")).getAttribute("value"));
